...
const MergeCommitment = (props) => {
  ...
  const { isMerging, setIsMerging, commitmentsToMerge, setCommitmentsToMerge } = mergeOps;
  ...
  return (
    <Stack gap="1">
      ...
      <Button size="small" icon="success" disabled={commitmentsToMerge.length < 2} variant="primary" />
    </Stack>
  );
};
